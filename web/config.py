...
class Config(object):
    ...
    try:
        ...
        print(
            f"Unable to retrieve accounts database credentials from ASM: {e}")
        raise e
    ...
    AWS_SNS_JOB_REQUEST_TOPIC = \
        "arn:aws:sns:us-east-1:659248683008:xuhanxie_job_requests"
    AWS_SNS_JOB_COMPLETE_TOPIC = \
        "arn:aws:sns:us-east-1:659248683008:xuhanxie_job_results"
    AWS_SNS_RESTORE_TOPIC = \
        "arn:aws:sns:us-east-1:659248683008:xuhanxie_restore"
    # Change the table name to your own
    AWS_DYNAMODB_ANNOTATIONS_TABLE = "xuhanxie_annotations"

    # Change the email address to your username
    MAIL_DEFAULT_SENDER = "xuhanxie@mpcs-cc.com"
